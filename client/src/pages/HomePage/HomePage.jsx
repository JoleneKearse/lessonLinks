          ...
          <div className="container">
            <div className="hero-content">
              <div className="hero-text">
                <h1>Can't Find the <span className="highlight-text">Perfect</span> Teaching Resource?</h1>
                <p>LessonLinks is the first teacher marketplace that empowers you to <span className="text-highlighter">request exactly what you need</span> and connect with creators who can create it for you.</p>
                <div className="hero-buttons">
                  <a href="/request" className="btn btn-large btn-highlight"><i className="fas fa-bullhorn"></i>Post Your Request</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="request-feature">
          <div className="container">
            <div className="section-title">
              ...
              <p>See what other teachers are looking for and fulfill their requests.</p>
            </div>
            ...
            <div className="request-cards-container">
              ...
              <div ref={sliderRef} className="request-cards">
                ...
                <a href="/browse-requests" className="request-card">
                  ...
                  <div className="request-card-body">
                    ...
                    <div className="request-meta">
                      <span><i className="fas fa-user"></i> Requested by Sarah T.</span>
                      <span><i className="fas fa-clock"></i> 7 mins ago</span>
                    </div>
                    <p className="request-description">Looking for an interactive notebook with hands-on activities for a 2-week ecosystems unit. Need food web activities and habitat explorations that align with NGSS standards.</p>
                    <div className="request-cta">
                      <span className="request-price">$30-45</span>
                      <a href="#" className="btn btn-primary">Create This Resource</a>
                    </div>
                  </div>
                </a>
                ...
                <a href="/browse-requests" className="request-card">
                  ...
                  <div className="request-card-body">
                    ...
                    <div className="request-meta">
                      <span><i className="fas fa-user"></i> Requested by Michael D.</span>
                      <span><i className="fas fa-clock"></i> 12 mins ago</span>
                    </div>
                    <p className="request-description">Need pre-assessment, formative assessments, and summative assessment for fractions unit. Should include visual models and word problems. Digital and printable versions required.</p>
                    <div className="request-cta">
                ...
                <a href="/browse-requests" className="request-card">
                  ...
                  <div className="request-card-body">
                    ...
                    <div className="request-meta">
                      <span><i className="fas fa-user"></i> Requested by Rebecca L.</span>
                      <span><i className="fas fa-clock"></i> 41 mins ago</span>
                    </div>
                    <p className="request-description">Seeking a 3-week unit on modern poetry analysis for grades 11-12. Should include diverse poets, analysis frameworks, writing prompts, and final creative project options.</p>
                    <div className="request-cta">
                ...
                <a href="/browse-requests" className="request-card">
                  ...
                  <div className="request-card-body">
                    ...
                    <div className="request-meta">
                      <span><i className="fas fa-user"></i> Requested by Alex K.</span>
                      <span><i className="fas fa-clock"></i> 1 hr ago</span>
                    </div>
                    <p className="request-description">A digital escape room focused on ancient Egypt, Greece, and Rome with interactive puzzles that teach key concepts about each civilization, designed to work in Google Slides and including a teacher guide.</p>
                    <div className="request-cta">
            ...
            <div className="active-requests">
              <a href="/browse-requests" className="btn btn-large btn-outline"><i className="fas fa-comments"></i>See All Requests</a>
            </div>
          </div>
        </section>
        ...
        <section className="how-it-works">
          <div className="container">
            <div className="section-title">
              ...
              <p>Our unique request feature connects you directly with teachers who can create exactly what you need</p>
            </div>
            <div className="process-steps">
              ...
              <div className="process-step">
                <div className="step-content">
                  ...
                  <p>Detail the resource you're looking for, including grade level, subject, standards, and your budget range.</p>
                </div>
              </div>
              <div className="process-step">
                <div className="step-content">
                  ...
                  <p>Qualified teacher-creators will respond with proposals and samples of their work.</p>
                </div>
              </div>
              <div className="process-step">
                <div className="step-content">
                  ...
                  <p>Choose the best creator, provide feedback, and get a resource tailored exactly to your needs.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <table className="comparison-table">
              ...
              <tbody>
                <tr className="feature-highlight">
                  <td><strong>Custom Resource Requests</strong></td>
                ...
                <tr className="feature-highlight">
                  ...
                  <td><i className="fas fa-check check-icon"></i> Sell your resources + fulfill custom requests</td>
                  <td><i className="fas fa-check check-icon"></i> Sell your resources only</td>
                </tr>
              </tbody>
            </table>
          </div>
